...
let accountLookup = Request(path: "/api/v1/accounts/\(lookup: "id")", method: .get)
...
let accountStatuses = Request(path: "/api/v1/accounts/\(lookup: "id")/statuses", method: .get, headers: [
